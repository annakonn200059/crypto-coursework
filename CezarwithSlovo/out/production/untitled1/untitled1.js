...
var untitled1 = function (_, Kotlin) {
  ...
  function transform(text, alphabet, oldalphabet, key) {
    ...
    for (var i = 0; i <= l; i++) {
      ...
      if (tmp$) {
        ...
        s += String.fromCharCode(alphabet.charCodeAt((k + key | 0) % alphabet.length));
      }
       else
  ...
  function wordwithoutkey(text, oldalph, alph, key) {
    ...
    for (var i = 0; i <= l; i++) {
      ...
      if (tmp$) {
        ...
        var a = (k - key | 0) >= 0 ? oldalph.charCodeAt((k - key | 0) % oldalph.length) : oldalph.charCodeAt(oldalph.length - (key - k) | 0);
        var o = indexOf(oldalph, toChar(String.fromCharCode(a | 0).toUpperCase().charCodeAt(0)));
        var tmp$_0 = String;
        var tmp$_1 = tmp$_0.fromCharCode;
        var $receiver_2 = alph.charCodeAt(o);
        s += tmp$_1.call(tmp$_0, toChar(String.fromCharCode($receiver_2 | 0).toUpperCase().charCodeAt(0)));
      }
       else
        s += String.fromCharCode(text.charCodeAt(i));
    }
  ...
  function main$lambda(closure$alphabetENG, closure$alphabetRUS, closure$openTextElement, closure$alphRussmall, closure$alphEngsmall, closure$cipherTextElement, closure$numberkeyElement, closure$keyElement) {
    return function (it) {
      ...
      var word = closure$openTextElement.v.value;
      var k_symbols = 0;
      ...
      if ((k_letters + k_symbols | 0) !== word.length) {
        return closure$cipherTextElement.v.value = '\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0434\u0430\u043D\u043D\u044B\u0435 \u043D\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u043E\u043C \u044F\u0437\u044B\u043A\u0435', Unit;
      }
       else {
        var numberkey = closure$numberkeyElement.value;
        ...
        closure$cipherTextElement.v.value = transform(closure$openTextElement.v.value, newalp, alphabet, toInt(numberkey));
        return false;
      }
    };
  }
  function main$lambda_0(closure$alphabetENG, closure$alphabetRUS, closure$cipherTextElement, closure$alphRussmall, closure$alphEngsmall, closure$openTextElement, closure$numberkeyElement, closure$keyElement) {
    return function (it) {
      var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
      var pushedel = Kotlin.isType(tmp$ = document.getElementById('lang'), HTMLSelectElement) ? tmp$ : throwCCE();
      var sellang = pushedel.value;
      ...
      var word = closure$cipherTextElement.v.value;
      var k_symbols = 0;
      tmp$_2 = iterator(word);
      while (tmp$_2.hasNext()) {
        var char_0 = unboxChar(tmp$_2.next());
      ...
      if ((k_letters + k_symbols | 0) !== word.length) {
        return closure$openTextElement.v.value = '\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0434\u0430\u043D\u043D\u044B\u0435 \u043D\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u043E\u043C \u044F\u0437\u044B\u043A\u0435', Unit;
      }
       else {
        var numberkey = closure$numberkeyElement.value;
        var keyword = closure$keyElement.value;
        var newkey = duplicate(keyword);
        var newalp = newkey + deletelettersfromalphabet(alphabet, transformKey(newkey, alphabet), newkey);
        closure$openTextElement.v.value = wordwithoutkey(closure$cipherTextElement.v.value, newalp, alphabet, toInt(numberkey));
        return false;
      }
    };
  }
  ...
  function main() {
    ...
    var numberkeyElement = Kotlin.isType(tmp$_0 = document.getElementById('key'), HTMLInputElement) ? tmp$_0 : throwCCE();
    var openTextElement = {v: Kotlin.isType(tmp$_1 = document.getElementById('open-text'), HTMLTextAreaElement) ? tmp$_1 : throwCCE()};
    var cipherTextElement = {v: Kotlin.isType(tmp$_2 = document.getElementById('cipher-text'), HTMLTextAreaElement) ? tmp$_2 : throwCCE()};
    var alphabetRUS = '\u0410\u0411\u0412\u0413\u0414\u0415\u0401\u0416\u0417\u0418\u0419\u041A\u041B\u041C\u041D\u041E\u041F\u0420\u0421\u0422\u0423\u0424\u0425\u0426\u0427\u0428\u0429\u042A\u042B\u042C\u042D\u042E\u042F';
    var alphabetENG = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
    var alphRussmall = {v: ''};
    tmp$_3 = iterator(alphabetRUS);
    while (tmp$_3.hasNext()) {
      var char = unboxChar(tmp$_3.next());
      alphRussmall.v += String.fromCharCode(toChar(String.fromCharCode(char | 0).toLowerCase().charCodeAt(0)));
    }
    var alphEngsmall = {v: ''};
    tmp$_4 = iterator(alphabetENG);
    while (tmp$_4.hasNext()) {
      var char_0 = unboxChar(tmp$_4.next());
      alphEngsmall.v += String.fromCharCode(toChar(String.fromCharCode(char_0 | 0).toLowerCase().charCodeAt(0)));
    }
    (Kotlin.isType(tmp$_5 = document.getElementById('encrypt-btn'), HTMLButtonElement) ? tmp$_5 : throwCCE()).onclick = main$lambda(alphabetENG, alphabetRUS, openTextElement, alphRussmall, alphEngsmall, cipherTextElement, numberkeyElement, keyElement);
    (Kotlin.isType(tmp$_6 = document.getElementById('decrypt-btn'), HTMLButtonElement) ? tmp$_6 : throwCCE()).onclick = main$lambda_0(alphabetENG, alphabetRUS, cipherTextElement, alphRussmall, alphEngsmall, openTextElement, numberkeyElement, keyElement);
    (Kotlin.isType(tmp$_7 = document.getElementById('swap-wrap'), HTMLButtonElement) ? tmp$_7 : throwCCE()).onclick = main$lambda_1;
  }
  _.transformKey_puj7f4$ = transformKey;
  _.transform_ibifho$ = transform;
  _.duplicate_61zpoe$ = duplicate;
  _.removeChar_4wanh1$ = removeChar;
  _.deletelettersfromalphabet_mtg1x$ = deletelettersfromalphabet;
  _.wordwithoutkey_ibifho$ = wordwithoutkey;
